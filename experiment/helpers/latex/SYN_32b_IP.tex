...
\begin{document}
\pgfplotstableread[col sep=comma]{bit-width/SYN-Tanh/32/quantized_layer_32_bits.csv}\iplaneTanh
\pgfplotstableread[col sep=comma]{bit-width/SYN-ReLU/32/quantized_layer_32_bits.csv}\iplaneRelu

...
\begin{document}
\pgfplotstableread[col sep=comma]{quantize/SYN-Tanh/8/quantized_layer_8_bits_X.csv}\tabX
\pgfplotstableread[col sep=comma]{quantize/SYN-Tanh/8/quantized_layer_8_bits_Y.csv}\tabY
\pgfplotstableread[col sep=comma]{quantize/SYN-Tanh/8/quantized_layer_8_bits_middle.csv}\iplane
